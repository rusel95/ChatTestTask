...
//    @discardableResult
//    public func autoregister<Service, Arg1>(initializer: @escaping (Arg1, Resolver) -> Service) -> Swinject.ServiceEntry<Service> {
...
//
//    @discardableResult
//    public func autoregister<Service, Arg1, Arg2>(argument arg1: Arg1.Type, initializer: @escaping (Arg1, Arg2) -> Service) -> Swinject.ServiceEntry<Service> {
